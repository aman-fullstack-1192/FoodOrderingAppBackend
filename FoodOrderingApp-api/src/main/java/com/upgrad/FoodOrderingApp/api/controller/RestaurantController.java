...
public class RestaurantController {
    ...
    // This endpoint is used to retrieve the list of all restaurants from database
    @CrossOrigin
    ...
    // This endpoint is used to retrieve the list of all restaurants by Category ID
